...
COPY covers/target/covers-1.0-SNAPSHOT.jar covers.jar

COPY frontend /var/www/html
CMD java -jar covers.jar & java -jar songs.jar & sleep 12 && java -jar authors.jar & sleep 12 && java -jar gateway.jar
